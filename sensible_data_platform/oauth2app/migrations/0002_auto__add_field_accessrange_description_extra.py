...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessRange.description_extra'
        db.add_column(u'oauth2app_accessrange', 'description_extra',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccessRange.description_extra'
        db.delete_column(u'oauth2app_accessrange', 'description_extra')
    ...
    models = {
        ...
        u'oauth2app.accessrange': {
            ...
            'description_extra': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'oauth2app.accesstoken': {
            ...
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1375525703'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1375522103'}),
            'mac_key': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'null': 'True', 'default': "'942db928b2'", 'max_length': '10', 'blank': 'True', 'unique': 'True', 'db_index': 'True'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'b52b48e86b'", 'unique': 'True', 'max_length': '10', 'db_index': 'True'}),
        ...
        u'oauth2app.client': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'8b01d6f79693c71b2ee5d2afc09640'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'e88120cd51046251aa714dad04a377'", 'unique': 'True', 'max_length': '30'}),
        ...
        u'oauth2app.code': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oauth2app.Client']"}),
            'expire': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1375522223'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1375522103'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'845fabf308b54dc15e638af436e5b1'", 'unique': 'True', 'max_length': '30', 'db_index': 'True'}),
