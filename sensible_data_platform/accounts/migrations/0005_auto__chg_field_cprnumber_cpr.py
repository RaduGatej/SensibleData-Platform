...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CPRNumber.cpr'
        db.alter_column(u'accounts_cprnumber', 'cpr', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CPRNumber.cpr'
        db.alter_column(u'accounts_cprnumber', 'cpr', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'accounts.cprnumber': {
            ...
            'cpr': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'accounts.extra': {
