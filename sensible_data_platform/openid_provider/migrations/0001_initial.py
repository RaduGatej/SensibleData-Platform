...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OpenID'
        db.create_table(u'openid_provider_openid', (
        ...
        db.send_create_signal(u'openid_provider', ['OpenID'])

        # Adding model 'TrustedRoot'
        db.create_table(u'openid_provider_trustedroot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'openid_provider', ['TrustedRoot'])


    def backwards(self, orm):
        # Deleting model 'OpenID'
        db.delete_table(u'openid_provider_openid')

        # Deleting model 'TrustedRoot'
        db.delete_table(u'openid_provider_trustedroot')
